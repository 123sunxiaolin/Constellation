...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray
{
    ...
    if (self) {
		...
		self.startPoint = CGPointMake(kQuadCurveMenuDefaultStartPointX, kQuadCurveMenuDefaultStartPointY);//菜单按钮的坐标
        
        // layout menus
        self.menusArray = aMenusArray;
        
        // add the "Add" Button.
        _addButton = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"menu.png"]
                                       highlightedImage:[UIImage imageNamed:@"menu-high.png"] 
                                           ContentImage:[UIImage imageNamed:@"home.png"] 
                                highlightedContentImage:[UIImage imageNamed:@"home1.png"]];
...
- (void)quadCurveMenuItemTouchesBegan:(QuadCurveMenuItem *)item//可以在这个方法中添加label
{
    if (item == _addButton) 
    {
        self.expanding = !self.isExpanding;
